...
?>
  ...
  <div class="container">
    <div class="benefits__inner">
      <img data-wow-delay="2s" class="benefits__img wow animate__fadeInUp" src="<?php bloginfo('template_url'); ?>/assets/img/car.png" alt="car">
    ...
    <div class="carousel__inner">
      ...
      <div class="carousel__item">
        <div class="carousel__item-box">
          <img class="carousel__item-img" src="<?php bloginfo('template_url'); ?>/assets/img/carousel/1.jpg" alt="">
      ...
      <div class="carousel__item">
        <div class="carousel__item-box">
          <img class="carousel__item-img" src="<?php bloginfo('template_url'); ?>/assets/img/carousel/2.jpg" alt="">
      ...
      <div class="carousel__item">
        <div class="carousel__item-box">
          <img class="carousel__item-img" src="<?php bloginfo('template_url'); ?>/assets/img/carousel/3.jpg" alt="">
          <h4 class="carousel__item-title">TESLA MODEL 3 2018 г.</h4>
          <p class="carousel__item-text">Экономия 5500 $</p>
        </div>
      </div>

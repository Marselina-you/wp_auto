...
?>
  ...
  <div class="container">
    ...
    <div class="services__inner">
      <div class="services__content">
       ...
       <?php the_field('service-text', 7); ?>
       <a class="button button--decor" href="#">КОНСУЛЬТАЦИЯ ЭКСПЕРТА</a>
      </div>

      <?php the_field('service-item', 7); ?>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <?php the_field('benefits-img'); ?>
      <img data-wow-delay="2s" class="benefits__images wow animate__fadeInUp" src=" <?php the_field('benefits-img', 7); ?>" alt="car">
      <div class="benefits__content">
        <h2 class="title benefits__title">ПОЧЕМУ МЫ?</h2>
       <?php the_field('benefits-text', 7); ?>
      </div>
    </div>
  </div>
</section>
